...
def run(depth):
    ...
    # set a depth target
    set_target_depth(depth=depth, master=master, boot_time=boot_time)
    ...
    for yaw_angle in range(0, 500, 10):
        set_target_attitude(roll=roll_angle, pitch=pitch_angle, yaw=yaw_angle, master=master, boot_time=boot_time)
